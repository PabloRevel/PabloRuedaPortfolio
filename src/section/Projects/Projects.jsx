            ...
            <Container>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={12} sm={6}>
                        <Card imgId={"projectOne"} color={"#06DDDD"} tech={"HTML, CSS, SASS, JS, React, Gatsby"} title={"Psychologist web site"} 
                    ...
                    <Grid item xs={12} sm={6}>
                        <Card imgId={"projectTwo"} color={"#06DDDD"} tech={"HTML, CSS, SASS, JS"} title={"Apple website clone"}
